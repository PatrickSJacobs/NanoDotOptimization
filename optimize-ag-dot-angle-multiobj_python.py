...
def sim(run_file, filenames=[], input_lines=[]):
    ...
    file1.writelines([
                    ...
                    [
                        ...
                        #f"python {new_file} True | tee -a {air_raw_path} ; grep flux1: {air_raw_path} > {air_data_path};\n",
                        #f"python {new_file} False | tee -a {metal_raw_path} ; grep flux1: {metal_raw_path} > {metal_data_path};\n"
