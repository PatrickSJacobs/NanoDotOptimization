...
def check_log(filename: str, param: str):
    ...
    return list(df.loc[df['filename'] == filename][param])
...
def evaluate_candidate(candidate):
    ...
    # y3 = get_values(x_input, 'c_var')  # If you want to include 'c_var', uncomment this
...
if __name__ == "__main__":
    ...
    printing(f"Number of objectives: {n_objectives}")
