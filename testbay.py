...
# Remove or comment out the inline magic
...
plt.savefig("hypervolume_difference.png", bbox_inches='tight')
plt.close()
...
# Save the figure to the local directory
plt.savefig("observations_colored_by_iteration.png", bbox_inches='tight')
plt.close()